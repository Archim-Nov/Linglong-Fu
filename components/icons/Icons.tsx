...
export const QuillIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20.7 19.3c.9.9 2.5.9 3.3 0 .9-.9.9-2.5 0-3.3l-1.8-1.8-1.2 1.2 1.8 1.8Z" />
        <path d="m2.1 2.1 10.3 10.3" />
        <path d="M10 13.5 6.5 10" />
        <path d="m15.5 5-3 3" />
        <path d="m12.5 11.5 9 8" />
        <path d="m17 6.5-3 3" />
        <path d="M14 12.5 10.5 9" />
        <path d="M3 11c-1.3 1.3-1.3 3.4 0 4.6l5 5c1.3 1.3 3.4 1.3 4.6 0l5-5" />
    </svg>
);
...
export const FanIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 12c-3 0-6 2.5-6 6s3 6 6 6 6-2.5 6-6"/>
        <path d="M12 12v-6"/>
        <path d="M10.5 9c-3-2.5-3.5-5-2-7.5"/>
        <path d="M13.5 9c3-2.5 3.5-5 2-7.5"/>
        <path d="M12 12c-1.5 0-3 1-3.5 2.5"/>
        <path d="M12 12c1.5 0 3 1 3.5 2.5"/>
    </svg>
);